...
async def init():
    ...
    await Hotty.start()
    try:
        await Hotty.stream_call("https://files.catbox.moe/ighc6x.jpg")
    ...
    LOGGER("BrandrdXMusic").info(
        "ᴅʀᴏᴘ ʏᴏᴜʀ ɢɪʀʟꜰʀɪᴇɴᴅ'ꜱ ɴᴜᴍʙᴇʀ ᴀᴛ @Sweet_chat_aao ᴊᴏɪɴ @MAHI_X_MUSIC_BOT , @All_super_music ꜰᴏʀ ᴀɴʏ ɪꜱꜱᴜᴇꜱ"
    )
    await idle()
    await app.stop()
    await userbot.stop()
